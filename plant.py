class Plant:
    def __init__(self, coord_x, coord_y, capacity, init, refill, libre):
        self._coord = (coord_x, coord_y)  # Stocke la position sous forme de tuple (x, y)
        self._capacity = capacity         # Capacité maximale de l’usine
        self._stock = init                # Nombre actuel de bouteilles pleines en stock
        self._refill = refill             # Nombre de bouteilles pouvant être remplies par jour
        self.libre = libre
